...
class TestNftablesEngine(NftablesTestCase):
    ...
    def test_scenario_multiple_zones(self):
        ...
        expected_commands = [
            ...
            "nft add rule inet fwsimple input iif eth2 ip6 saddr 2001:db8:dmz::/64 jump ZONE_IN_dmz_ipv6 comment \"\\\"Zone dmz_ipv6\\\"\"",
            "nft add rule inet fwsimple output oif eth2 ip6 daddr 2001:db8:dmz::/64 jump ZONE_OUT_dmz_ipv6 comment \"\\\"Zone dmz_ipv6\\\"\"",
            "nft add rule inet fwsimple forward iif eth2 ip6 saddr 2001:db8:dmz::/64 jump ZONE_FWD_dmz_ipv6 comment \"\\\"Zone dmz_ipv6\\\"\"",
